/*
    ...
    The depth of the root of the tree is 0. if the depth of a node is d, the depth of each 
    of its children is d + 1.
...
class Solution {
    public:
        ...
        TreeNode* lcaDeepestLeaves(TreeNode* root) {
            ...
            TreeNode* i=arr[0];
            TreeNode* j=arr[arr.size()-1];
            if(arr.size()==1) return i;
